...
from bdg.utils import are_parameters_in_registers, find_elf_files_containing, get_addrs_string
    ...
    def discover_new_binaries(self):
        ...
        for role, data_key, name_fun in zip(self._roles, self._data_keys, self._name_funs):
            ...
            if role == Role.SETTER and name_fun and data_key:
                ...
                candidate_bins = find_elf_files_containing(self._fw_path, [data_key, dual_fun])
